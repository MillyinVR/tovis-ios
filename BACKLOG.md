...
- [~] Calendar parity: **tap-to-create ✅, drag-to-reschedule ✅ (#99/#100), booking-override retry dialog ✅, passive double-book warning ✅ (#104 tiles/reschedule + #105 new-booking form), side-by-side overlap columns ✅ (#116), working-hours shading ✅ (#117), `ManagementModal` message + confirm-deny ✅ (#118), drag haptics ✅ (#119), bottom-edge resize ✅ (#121).** Remaining: drag follow-ups (cross-day / blocks — below).
