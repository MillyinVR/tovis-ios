...
- [~] Calendar parity: **tap-to-create ✅, drag-to-reschedule ✅ (#99/#100), booking-override retry dialog ✅, passive double-book warning ✅ (#104 tiles/reschedule + #105 new-booking form).** Remaining: working-hours shading, side-by-side overlap columns, full `ManagementModal` (pending/waitlist list).
